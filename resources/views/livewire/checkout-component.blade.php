    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Checkhout</span></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            <h1 style="font-size: 20px" class="box-title">:للطلب أدخل معلوماتك هنا</h3>
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="lname" style="font-size: 20px">:الاسم الكامل<span>*</span></label>
                                    <input  type="text" name="lname" value="" placeholder="Nom et Prenom" wire:model="lastname">
                                ...
                                <p class="row-in-form">
                                    <label for="phone" style="font-size: 20px">:رقم الهاتف<span>*</span></label>
                                    <input  type="number" name="phone" value="" placeholder="numero de telephone" wire:model="mobile">
                                    @error('mobile') <span class="text-danger">{{ $message }}</span>@enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add"  style="font-size: 20px">:العنوان</label>
                                    <input style="width:400px;padding:10px" ype="text" name="add" value="" placeholder="Address..." wire:model="line1">
                                    @error('line1') <span class="text-danger">{{ $message }}</span>@enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add">:فين ساكن بالضبط </label>
                                    <input ype="text" name="add" value="" placeholder="adress exact ..." wire:model="line2">
                                    @error('line2') <span class="text-danger">{{ $message }}</span>@enderror
                                </p> 
                                {{-- <p class="row-in-form">
                                    <label for="country" style="font-size: 20px">:البلد<span>*</span></label>
                                    <input  type="text" name="country" value="" placeholder="compagne..." wire:model="country">
                                ...
                                <p class="row-in-form">
                                    <label for="city" style="font-size: 20px">:المدينة<span>*</span></label>
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input ype="text" name="add" value="" placeholder="Street at apartment number" wire:model="s_line1">
                                    @error('s_line1') <span class="text-danger">{{ $message }}</span>@enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add"> :فين ساكن بالضبط</label>
                                    <input ype="text" name="add" value="" placeholder="United States" wire:model="s_line2">
                                    @error('s_line2') <span class="text-danger">{{ $message }}</span>@enderror
                                    
                                </p>
                                <p class="row-in-form">
                                    <label for="country">:البلد <span>*</span></label>
