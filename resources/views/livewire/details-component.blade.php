                        ...
                        <div class="product-gallery" wire:ignore>
                          <ul class="slides">
                            ...
                            <li  data-thumb= " {{ asset('assets/images/products')}}/{{ $product->image }}" >
                                <img style="height: 430px;width:400px"  src="{{ asset('assets/images/products')}}/{{ $product->image }}" alt=" {{ $product->name }} " />
                            </li>
                            @php 
                            ...
                            @foreach($images as $image)
                                ...
                                <li data-thumb="{{ asset('assets/images/products')}}/{{ $image }}">
                                    <img style="height: 460px;width:460px"  src=" {{ asset('assets/images/products')}}/{{ $image }}" alt=" {{ $product->name }} " />
                                </li>
                                @endif
                            @endforeach
                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @php 
                                $avgrating=0
                            @endphp
                            @foreach($product->orderItems->where('revstatus',1) as $orderItem)
                               @php  
                            ...
                            @endif
                            @endfor                          
                            <a href="#" class="count-review">({{ $product->orderItems->where('revstatus',1)->count() }}Review)</a>
                        </div>
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">{{ $product->orderItems->where('revstatus',1)->count() }} review for <span>{{ $product->name }}</span></h2>
