<div>
    <footer id="footer">
		<div class="wrap-footer-content footer-style-1">
			...
			<div class="wrap-function-info" style="background: rgb(0, 0, 0)">
				<div class="container"  >
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc" style="color: rgb(255, 0, 0)">Free On Oder Over $99</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc"  style="color: rgb(255, 0, 0)">30 Days Money Back</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc"  style="color: rgb(255, 0, 0)">Safe your online payment</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc"  style="color: rgb(255, 0, 0)">We Have Support 24/7</p>
							</div>
			...
			<div class="coppy-right-box" >
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Number One of Casablanca. All rights reserved</p>
					</div>
