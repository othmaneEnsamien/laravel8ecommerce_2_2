                    ...
                    <div class="panel-body">
                        ...
                        <form wire:submit.prevent="updateCoupon" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Coupon Code" class="form-control inpu-md" wire:model="code">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Coupon Value " class="form-control inpu-md" wire:model="value">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                   <input type="text" placeholder="Cart Value" class="form-control input-md"  wire:model="expiry_date">
