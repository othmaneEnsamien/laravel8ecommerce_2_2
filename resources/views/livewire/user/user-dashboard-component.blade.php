        ...
        <div class="row">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Total Coût</span>
            ...
            <div class="col-md-3 col-sm-6">    
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Total achat</span>
                      ...
                      <table class="table table-striped">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td><a href="{{ route('user.ordersdetails',['order_id'=>$order->id]) }}" class="btn btn-info btn-sm">Details</td>
