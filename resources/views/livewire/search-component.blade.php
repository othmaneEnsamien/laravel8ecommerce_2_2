    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Tous les produits</span></li>
            </ul>
        </div>
        <div class="row">
                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})">Ajouter dans le panier</a>
                                        <div class="product-wish">
                                            @if ($witems->contains($product->id))
                                            <a wire:click.prevent="removefromwishlist({{ $product->id }})"  href="{{ route('shop') }}"><i class="fa fa-heart fill-heart"></i></a>
                                            @else 
                                    ...
                                    <ul class="sub-cate">
                                        @foreach($cat->subCategoryys as $scategory)
                                            <li class="category-item">
                                                <a style="color:rgb(0, 0, 0)" href="{{ route('product.category',['category_slug'=>$cat->slug , 'scategory_slug'=>$scategory->slug]) }}" class="cat-link"><i class="fa fa-caret-right"></i>{{ $scategory->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                @endif                               
